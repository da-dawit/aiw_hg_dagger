...
\node[proc,fill=figFlag,text width=54mm,line width=1.2pt] (v21) at (26.0,4.6)
 {\textbf{LeRobot v2.1} as written by \texttt{to\_lerobot\_v21.py}\\
  \scriptsize the format Isaac-GR00T requires\\[0.6mm]
  \scriptsize index, episode\_index, task\_index, timestamp,\\
  \scriptsize observation.state, action, subtask\_index\\[0.6mm]
  \scriptsize \textcolor{figHuman}{\textbf{intervention, reward, done, sample\_weight}}\\
  \scriptsize \textcolor{figHuman}{\textbf{not emitted by this writer}}};
