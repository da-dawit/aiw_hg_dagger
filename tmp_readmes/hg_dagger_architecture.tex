...
T4 & \small PUB/SUB & \texttt{\small /leader/teleoperation/\allowbreak control\_status} & \texttt{\small robotis\_interfaces/\allowbreak ControlModeStatus} & \small \texttt{active\_arms} + mode. \textbf{Not recorded}: \texttt{robotis\_interfaces} is absent in the recorder, and adding it killed the launch group. Use T5.\\
